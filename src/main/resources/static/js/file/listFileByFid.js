    ...
    layer.open({
        ...
        yes: function (index, layero) {
            ...
            $.ajax({
                ...
                type: "post",
                dataType: "json",
                data: "pid=" + getUrlValue("pid") + "&fid=" + getUrlValue("fid") + "&name=" + fileName + "&keyword=" + keyword + "&priority=" + priority + "&url=" + url + "&videoLength=" + videoLength + "&remark=" + remark,
                headers: {
                    'Authorization': getCookie("token")
                },
                success: function (res) {
